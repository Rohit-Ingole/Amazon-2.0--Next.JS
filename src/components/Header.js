    ...
    <header>
      <div className="bg-amazon_blue pb-2 sm:pb-0 px-2 sm:px-0">
        <div className="flex items-center bg-amazon_blue flex-grow p-1 py-2">
          <div className="mt-2 flex items-center flex-grow sm:flex-grow-0 mr-3.5">
            <Image
      ...
      <div className="bg-amazon_blue-light flex items-center w-full text-white text-sm lg:space-x-3 space-x-2.5 py-1 sm:px-6 font-semibold ">
